...
memory:
  ...
  embeddings:
    model: auto          # auto-detect the local server's embedding model; or pin an id, or 'hashing' to force offline
    dimensions: 768
  vector_index:
    backend: sqlite-vec
